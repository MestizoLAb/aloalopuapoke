...
export const menu: MenuCategory[] = [
  ...
  },
  {
    ...
    dishes: [
      ...
      },
      {
        ...
        desc: {
          it: "Tortilla chips, avocado, jalapeño, salsa teriyaki e cipollotto. A scelta: tonno, salmone o gamberi.",
          en: "Tortilla chips, avocado, jalapeño, teriyaki sauce and spring onion. Your choice: tuna, salmon or prawn.",
        },
        sizes: [
  ...
  },
  {
    ...
    dishes: [
      { id: "acqua-nat", name: { it: "Acqua naturale", en: "Still water" }, desc: { it: "", en: "" }, price: "1,00" },
      { id: "acqua-friz", name: { it: "Acqua frizzante", en: "Sparkling water" }, desc: { it: "", en: "" }, price: "1,00" },
      ...
      { id: "te-pesca", name: { it: "Thè alla pesca San Benedetto 33cl", en: "Peach tea San Benedetto 33cl" }, desc: { it: "", en: "" }, price: "3,00" },
      { id: "te-limone", name: { it: "Thè al limone San Benedetto 33cl", en: "Lemon tea San Benedetto 33cl" }, desc: { it: "", en: "" }, price: "3,00" },
      { id: "charitea", name: { it: "ChariTea Mate", en: "ChariTea Mate" }, desc: { it: "Tè mate biologico e fairtrade.", en: "Organic, fairtrade mate tea." }, price: "4,00" },
      { id: "charitea-green", name: { it: "ChariTea Green", en: "ChariTea Green" }, desc: { it: "Tè verde biologico e fairtrade.", en: "Organic, fairtrade green tea." }, price: "4,00" },
      { id: "lemonaid-blood", name: { it: "Lemonaid Blood Orange", en: "Lemonaid Blood Orange" }, desc: { it: "", en: "" }, price: "4,00" },
      { id: "lemonaid-passion", name: { it: "Lemonaid Passion Fruit", en: "Lemonaid Passion Fruit" }, desc: { it: "", en: "" }, price: "4,00" },
      { id: "lemonaid-lime", name: { it: "Lemonaid Lime", en: "Lemonaid Lime" }, desc: { it: "", en: "" }, price: "4,00" },
      { id: "lemonaid-zenzero", name: { it: "Lemonaid Zenzero", en: "Lemonaid Ginger" }, desc: { it: "", en: "" }, price: "4,00" },
      { id: "te-pompelmo", name: { it: "Tè orientale al pompelmo", en: "Oriental grapefruit tea" }, desc: { it: "", en: "" }, price: "4,00" },
      { id: "te-gelsomino", name: { it: "Tè orientale al gelsomino", en: "Oriental jasmine tea" }, desc: { it: "Senza zuccheri.", en: "Sugar-free." }, price: "4,00" },
    ],
  },
  {
    id: "birre",
    ...
    dishes: [
      { id: "corona", name: { it: "Corona 33cl", en: "Corona 33cl" }, desc: { it: "", en: "" }, price: "4,00" },
      { id: "raffo", name: { it: "Raffo grezza 45cl", en: "Raffo grezza 45cl" }, desc: { it: "Bionda non filtrata, 4,8%.", en: "Unfiltered lager, 4.8%." }, price: "5,00" },
      { id: "mahou", name: { it: "Mahou Session IPA 33cl", en: "Mahou Session IPA 33cl" }, desc: { it: "", en: "" }, price: "5,00" },
      { id: "leffe", name: { it: "Leffe Blonde 33cl", en: "Leffe Blonde 33cl" }, desc: { it: "", en: "" }, price: "5,00" },
      { id: "hoegaarden", name: { it: "Hoegaarden Blanche 33cl", en: "Hoegaarden Blanche 33cl" }, desc: { it: "", en: "" }, price: "5,00" },
    ],
  },
];
