...
export const signatureBowls: Dish[] = [
  ...
  },
  {
    ...
    desc: {
      it: "Lattuga, tofu, salsa purple soy, pomodorini, avocado, carote, edamame, cavolo rosso e mandorle.",
      en: "Lettuce, tofu, purple-soy sauce, cherry tomatoes, avocado, carrots, edamame, red cabbage and almonds.",
    },
